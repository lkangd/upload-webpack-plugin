# Contributing upload-webpack-plugin

We'd always love contributions to further improve upload-webpack-plugin!
...
- version of the upload-webpack-plugin you are creating a bug report for
...
{
  "devDependencies": {
    "upload-webpack-plugin": "lkangd/upload-webpack-plugin#{id}/head"
  }
}
```
